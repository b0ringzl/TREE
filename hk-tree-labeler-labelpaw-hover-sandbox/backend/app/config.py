...
ROOT_DIR = Path(os.getenv("TREE_ROOT", str(PROJECT_DIR.parent))).resolve()
...
TREE_REGISTRY_DIR = PROJECT_DIR / "backend" / "data"
TREE_REGISTRY_DB = TREE_REGISTRY_DIR / "tree_registry.sqlite"
LABEL_MERGE_MAP = (ROOT_DIR / "tools" / "tree_species_label_merge_map.csv").resolve()
...
SAM_HOVER_IDLE_TIMEOUT_SEC = int(os.getenv("SAM_HOVER_IDLE_TIMEOUT_SEC", "900"))


def ensure_runtime_dirs() -> None:
    for path in (ROOT_DIR, SPECIES_DIR, TEMP_DIR, DATASET_DIR, RUNTIME_DIR, TREE_REGISTRY_DIR):
