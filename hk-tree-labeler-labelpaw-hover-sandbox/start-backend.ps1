...
$Runtime = "D:\TREE\hk-tree-labeler-labelpaw-hover-sandbox\.runtime"
...
Set-Location "D:\TREE\hk-tree-labeler-labelpaw-hover-sandbox\backend"
$Python = "D:\TREE\hk-tree-labeler-labelpaw-hover-sandbox\backend\.venv\Scripts\python.exe"
if (-not (Test-Path $Python)) {
    $Python = "D:\TREE\hk-tree-labeler\backend\.venv\Scripts\python.exe"
}
& $Python -m uvicorn app.main:app --host 127.0.0.1 --port 8010 *>> "D:\TREE\hk-tree-labeler-labelpaw-hover-sandbox\backend\server.log"
